...
export async function POST(request) {
  try {
    ...
    // Build a context-rich analytical prompt mapping user parameters
    const prompt = `
    ...
    // Fetch call directly interacting with Google Gemini API Gateway
    ...
    // Parse the clean structured JSON array generated directly by the engine
